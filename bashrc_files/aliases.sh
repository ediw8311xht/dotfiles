...
alias_with_completion ll  'lsd'     '-l --group-directories-first --icon="never" -rt --permission="octal"' #  --date=+" [ %_H:%M:%S | %a | %D ]" --blocks="permission,user,date,name"'
alias_with_completion ll_full 'lsd'     '--group-directories-first --icon="never" -rt --permission="octal" --date=+" [ %_H:%M:%S | %a | %D ]" --blocks="permission,user,date,name"'
...
alias_with_completion ggf 'g' '-l --file --time-style=+"%-2m  %-2d | %Y" --dir-first' # --table --table-style=unicode'
