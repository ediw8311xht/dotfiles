...
alias_with_completion nv             'nvim'
alias_with_completion nv_s           'nvim'      '+"AutoSession search"'
alias_with_completion o_rg           'source'    '"${HOME}/bin/rg_fzf.sh"'
alias_with_completion o_xdg          'xdg-open'  '"$(fzf --preview="ctpv {}")"'
...
alias_with_completion pyi    'ipython'
...
alias_with_completion szofall 'du' '-ahc  --time --max-depth=1'
...
# {{{ removed
# alias_with_completion gf 'fd' '--search-path "/" -u --mount'
...
# alias_with_completion py_venv_a 'source   .venv/bin/activate'
