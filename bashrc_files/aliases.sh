...
alias C_wallz='     cd     "${WALLPAPERS}"'
alias C_ww='        cd     "${MY_WEB}"'
#--------------------------------------------------edit----------------------------------#
...
alias e_fnv='     fd . -tf -0 "${HOME}/.config/nvim/" "${HOME}/.local/share/nvim/site/ftplugin/" -X nvim -c "Buffers"'
...
alias nf='        fzf_edit'
#----------------------------------------------------------------------------------------#
alias ebash='     nvim -c "Buffers" "${HOME}/bashrc_files/"* "${HOME}/.bash_completion" "${HOME}/.bashrc" "${HOME}/.bash_profile" ; source "${HOME}/.bashrc"'
